...
- `src/hooks/useFaceLandmarker.ts`: MediaPipe model loading and per-frame face detection.
...
4. Landmark data is converted into bounding boxes, head pose, and attention state.
